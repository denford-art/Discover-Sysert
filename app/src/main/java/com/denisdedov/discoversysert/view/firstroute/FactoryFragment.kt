...
class FactoryFragment : Fragment(), SeekBar.OnSeekBarChangeListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener,
    ...
    private val imgIdList = listOf(
        ...
        R.drawable.history_factory_draw,
        R.drawable.history_factory_new,
        R.drawable.history_factory_dirt,
    )
    ...
    private fun createMediaPlayerIfNeeded() {
        if (mMediaPlayer == null) {
            mMediaPlayer = MediaPlayer.create(activity, R.raw.factory)
    ...
    private fun initImg() {
        binding.apply {
            rvImageFactory.layoutManager = LinearLayoutManager(activity,
                LinearLayoutManager.HORIZONTAL, false)
            rvImageFactory.adapter = carouselAdapter
