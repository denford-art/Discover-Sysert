...
class HillFragment : Fragment(), SeekBar.OnSeekBarChangeListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener,
    ...
    lateinit var binding: FragmentHillBinding
    ...
    private fun createMediaPlayerIfNeeded() {
        if (mMediaPlayer == null) {
            mMediaPlayer = MediaPlayer.create(activity, R.raw.hill)
    ...
    private fun initImg() {
        binding.apply {
            rvImageHill.layoutManager = LinearLayoutManager(activity,
                LinearLayoutManager.HORIZONTAL, false)
            rvImageHill.adapter = carouselAdapter
