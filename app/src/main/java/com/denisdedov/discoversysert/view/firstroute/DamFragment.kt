...
import com.denisdedov.discoversysert.databinding.FragmentDamBinding
...
class DamFragment : Fragment(), SeekBar.OnSeekBarChangeListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener,
    MediaPlayer.OnPreparedListener, MediaPlayer.OnSeekCompleteListener, View.OnClickListener {

    lateinit var binding: FragmentDamBinding
    private val carouselAdapter: CarouselAdapter = CarouselAdapter()
    private val imgIdList = listOf(
        R.drawable.history_dam_render,
        R.drawable.history_dam_render,
        R.drawable.history_dam_render,
        R.drawable.history_dam_render,
        R.drawable.history_dam_render,
    ...
    override fun onCreateView(
        ...
        mapView = binding.mapviewDamHistory
    ...
    private fun createMediaPlayerIfNeeded() {
        if (mMediaPlayer == null) {
            mMediaPlayer = MediaPlayer.create(activity, R.raw.dam)
    ...
    private fun initImg() {
        binding.apply {
            rvImageDam.layoutManager = LinearLayoutManager(activity,
                LinearLayoutManager.HORIZONTAL, false)
            rvImageDam.adapter = carouselAdapter
