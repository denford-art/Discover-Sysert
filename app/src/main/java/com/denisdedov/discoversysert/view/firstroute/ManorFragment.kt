...
import com.denisdedov.discoversysert.databinding.FragmentManorBinding
...
class ManorFragment : Fragment(), SeekBar.OnSeekBarChangeListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener,
    MediaPlayer.OnPreparedListener, MediaPlayer.OnSeekCompleteListener, View.OnClickListener {

    lateinit var binding: FragmentManorBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentManorBinding.inflate(inflater, container, false)
        initImg()

        mapView = binding.mapviewManorHistory
    ...
    private fun createMediaPlayerIfNeeded() {
        if (mMediaPlayer == null) {
            mMediaPlayer = MediaPlayer.create(activity, R.raw.manor)
    ...
    private fun initImg() {
        binding.apply {
            rvImageManor.layoutManager = LinearLayoutManager(activity,
                LinearLayoutManager.HORIZONTAL, false)
            rvImageManor.adapter = carouselAdapter
